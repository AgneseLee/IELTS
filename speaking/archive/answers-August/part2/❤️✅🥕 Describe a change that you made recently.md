...
<!-- REFLECTION_START -->
I’m really <mark style="background: #ABF7F7A6;">glad</mark> I made this change because it gave me a sense of <mark style="background: #ABF7F7A6;">direction</mark> when I felt <mark style="background: #ABF7F7A6;">uncertain</mark> about the future. More importantly, the routine also strengthened my <mark style="background: #ABF7F7A6;">problem-solving skills</mark> because I learned to focus on what I could control rather than worrying about every possible result. The change helped me regain <mark style="background: #ABF7F7A6;">confidence</mark> and showed me that challenges can be handled by breaking them down into manageable steps.
