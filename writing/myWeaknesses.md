...
**规律：国名含复数或普通名词时加 `the`，单数专有名词不加。**

| 加 `the` | 原因 |
|---|---|
| the Philippines | 复数（群岛）|
| the Netherlands | 复数 |
| the Maldives | 复数（群岛）|
| the United States | 含普通名词 States |
| the United Kingdom | 含普通名词 Kingdom |

| 不加 `the` | 原因 |
|---|---|
| Malaysia / Indonesia / Thailand | 单数专有名词 |
| France / Japan / China | 单数专有名词 |

**口诀：** 国名里有普通名词（islands / states / kingdom）或是复数形式 → 加 `the`。
