...
> 对应 [`part2/topic-bank.md`](part2/topic-bank.md) 的 338 道 Part 3 问题。问法与模块编码见 [`part3-topic-bank.md`](part3-topic-bank.md)。映射用于检索，不需要背诵。

## 人物

### 想从事医疗行业的人

1. **Do you think being a doctor is easy or difficult?** — `Q5` · `M04-💙` 健康与福祉
2. **Do you think learning biology is interesting for children?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M13-❤️` 年龄与代际
3. **Why do some children want to become doctors?** — `Q1` · `M04-💙` 健康与福祉 ＋ `M13-❤️` 年龄与代际
4. **Do you think governments should put a large amount of money into medical research?** — `Q5` · `M04-💙` 健康与福祉 ＋ `M07-💚` 成本与资源
5. **Why do some doctors get paid more than others?** — `Q1` · `M07-💚` 成本与资源 ＋ `M11-❤️` 经济与就业
6. **Do you think doctors should be paid more?** — `Q5` · `M07-💚` 成本与资源 ＋ `M11-❤️` 经济与就业
...
6. **Do you want to be a famous person?** — `Q5` · `M15-💙` 名人与广告

### 克服困难成功的人

1. **In your country, what industry is it easier to be successful in?** — `Q7` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能
2. **What's the difference between ordinary people and successful people?** — `Q2` · `M03-❤️` 学习与技能 ＋ `M11-❤️` 经济与就业
3. **What are the factors leading to people's success?** — `Q1` · `M08-💙` 信息与判断 ＋ `M03-❤️` 学习与技能
...
5. **What can people do to protect the natural world?** — `Q6` · `M12-💙` 环境与可持续性
6. **Is it important to teach students environmental protection at school?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M12-💙` 环境与可持续性
...
1. **Is it necessary to keep learning after graduating from school?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
2. **Should teachers make learning in their classes fun?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
3. **Do you think there are too many subjects for students to learn?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
4. **Is it better to focus on a few subjects or to learn many subjects?** — `Q2` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
5. **Do you think enterprises should provide training for their employees?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M11-❤️` 经济与就业
6. **Do you think it is good for older adults to continue learning?** — `Q5` · `M02-💚` 公平与机会 ＋ `M03-❤️` 学习与技能

### 擅长学习和说语言的人

1. **Are there many people who can speak foreign languages in your country?** — `Q5` · `M05-💙` 沟通与信任 ＋ `M20-❤️` 科技媒体与隐私
2. **Does speaking other languages help at work?** — `Q5` · `M05-💙` 沟通与信任 ＋ `M11-❤️` 经济与就业
3. **Do people learn any languages other than English?** — `Q5` · `M05-💙` 沟通与信任 ＋ `M03-❤️` 学习与技能
4. **Why is it easier for children to learn new things than for adults?** — `Q1` · `M03-❤️` 学习与技能 ＋ `M13-❤️` 年龄与代际
5. **How do people learn new things?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
6. **What is the most important thing for learning a language well?** — `Q7` · `M05-💙` 沟通与信任 ＋ `M03-❤️` 学习与技能
...
1. **Why do some people start their own business?** — `Q1` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能
2. **Should governments provide financial support to start-ups?** — `Q5` · `M02-💚` 公平与机会 ＋ `M07-💚` 成本与资源
3. **Do most people prefer shopping at big stores or small stores?** — `Q2` · `M11-❤️` 经济与就业 ＋ `M01-💚` 便利与效率
4. **What makes a business successful?** — `Q1` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能
5. **What makes a business fail?** — `Q1` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能
6. **Is it easy to set up a new business in your country?** — `Q5` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能

### 发小

1. **Do you still keep in touch with your friends from childhood? Why or why not?** — `Q5` · `M09-❤️` 关系与归属感 ＋ `M05-💙` 沟通与信任
2. **How important is childhood friendship to children?** — `Q5` · `M09-❤️` 关系与归属感 ＋ `M13-❤️` 年龄与代际
3. **What do you think of communicating with others through social media?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M05-💙` 沟通与信任
4. **Do you think online communication through social media will replace face-to-face communication?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M05-💙` 沟通与信任
5. **What's the difference between talking to friends and family?** — `Q2` · `M05-💙` 沟通与信任 ＋ `M09-❤️` 关系与归属感
6. **Has technology changed people's friendships? How?** — `Q3` · `M20-❤️` 科技媒体与隐私 ＋ `M09-❤️` 关系与归属感

### 喜欢画画的孩子

1. **What is the right age for a child to learn drawing?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M17-❤️` 艺术娱乐与想象力
2. **Why do most children draw more often than adults do?** — `Q1` · `M13-❤️` 年龄与代际
3. **Why do some people visit galleries or museums instead of viewing artworks online?** — `Q1` · `M20-❤️` 科技媒体与隐私 ＋ `M17-❤️` 艺术娱乐与想象力
4. **Do you think galleries and museums should be free of charge?** — `Q5` · `M02-💚` 公平与机会 ＋ `M07-💚` 成本与资源
5. **How do artworks inspire people?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
6. **What are the differences between reading a book and visiting a museum?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
...
6. **Do most people think news about celebrities is boring?** — `Q5` · `M08-💙` 信息与判断 ＋ `M15-💙` 名人与广告
...
1. **What types of buildings are popular in your country?** — `Q7` · `M18-❤️` 地点建筑与设施
2. **Is it worth spending a lot of money on the exterior appearance of a building?** — `Q5` · `M07-💚` 成本与资源 ＋ `M18-❤️` 地点建筑与设施
3. **Is it more important for a building to look good on the outside or on the inside?** — `Q5` · `M18-❤️` 地点建筑与设施
4. **Why do people like to visit historical sites?** — `Q1` · `M18-❤️` 地点建筑与设施 ＋ `M22-💚` 文化身份与传统
5. **Do you think it's reasonable to charge an entry fee for visiting interesting buildings?** — `Q5` · `M02-💚` 公平与机会 ＋ `M07-💚` 成本与资源
6. **Is it better to live in a new building or an old one?** — `Q2` · `M18-❤️` 地点建筑与设施
...
1. **Why do people buy things they don’t need?** — `Q1` · `M19-❤️` 习惯情绪与休闲 ＋ `M15-💙` 名人与广告
2. **Do you think it's a waste of time to go shopping?** — `Q5` · `M11-❤️` 经济与就业 ＋ `M01-💚` 便利与效率
3. **Why are some people keen on shopping?** — `Q1` · `M19-❤️` 习惯情绪与休闲 ＋ `M15-💙` 名人与广告
...
1. **Is it easy to find quiet places in your country? Why?** — `Q5` · `M19-❤️` 习惯情绪与休闲 ＋ `M04-💙` 健康与福祉
2. **Why do old people prefer to live in quiet places?** — `Q1` · `M13-❤️` 年龄与代际 ＋ `M19-❤️` 习惯情绪与休闲
3. **Why are there more noises made at home now than in the past?** — `Q3` · `M19-❤️` 习惯情绪与休闲 ＋ `M04-💙` 健康与福祉
4. **Why do some people like to use noise as background sound when they are working or studying?** — `Q1` · `M19-❤️` 习惯情绪与休闲 ＋ `M04-💙` 健康与福祉
5. **How do people spend their leisure time in your country?** — `Q7` · `M11-❤️` 经济与就业 ＋ `M19-❤️` 习惯情绪与休闲
6. **How does technology affect the way people spend their leisure time?** — `Q7` · `M20-❤️` 科技媒体与隐私 ＋ `M11-❤️` 经济与就业
7. **Do you think only old people have time for leisure?** — `Q5` · `M13-❤️` 年龄与代际 ＋ `M19-❤️` 习惯情绪与休闲
...
1. **Are there many tall buildings in your country?** — `Q5` · `M18-❤️` 地点建筑与设施
...
1. **How important is it for schools to help children become smarter?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M13-❤️` 年龄与代际

### 遇到的科技问题

1. **What are the advantages and disadvantages of AI?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
2. **Do you think people today should learn about AI technology?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能
3. **Should children learn to use AI?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能
4. **How can AI help in our lives?** — `Q6` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
5. **Do you think students are overly reliant on AI?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能
6. **What can teachers do to stop students relying too much on AI?** — `Q6` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能

### 鼓励别人做不愿做的事

1. **How can leaders encourage their employees?** — `Q6` · `M21-💚` 合作领导与帮助 ＋ `M05-💙` 沟通与信任
...
1. **In what situations do people spend a long time responding to others' messages?** — `Q7` · `M05-💙` 沟通与信任 ＋ `M11-❤️` 经济与就业
2. **In what situations do people not respond to messages right away?** — `Q7` · `M05-💙` 沟通与信任 ＋ `M20-❤️` 科技媒体与隐私
3. **What would you do if you haven't received a reply after sending out a message?** — `Q7` · `M05-💙` 沟通与信任 ＋ `M20-❤️` 科技媒体与隐私
4. **Why do some people prefer sending a message instead of making a call?** — `Q1` · `M05-💙` 沟通与信任 ＋ `M20-❤️` 科技媒体与隐私
5. **Are you more polite when sending a message to a stranger than to a friend?** — `Q5` · `M05-💙` 沟通与信任 ＋ `M09-❤️` 关系与归属感
6. **Why do some people feel angry when others don't reply to their message?** — `Q1` · `M05-💙` 沟通与信任 ＋ `M20-❤️` 科技媒体与隐私

### 在团队中工作

1. **Why do some people prefer to work by themselves?** — `Q1` · `M21-💚` 合作领导与帮助
2. **What should a leader do to make team members want to follow him or her?** — `Q6` · `M21-💚` 合作领导与帮助
3. **Should students learn to do group work?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M21-💚` 合作领导与帮助
4. **What group tasks are there in schools?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M10-💙` 创造力与探索
5. **What advantages are there for students experiencing teamwork at school?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M21-💚` 合作领导与帮助
6. **How can you tell if a person is a good leader?** — `Q6` · `M21-💚` 合作领导与帮助

### 早起经历

1. **Do you know anyone who likes to get up early?** — `Q5` · `M19-❤️` 习惯情绪与休闲 ＋ `M04-💙` 健康与福祉
...
1. **When would parents feel proud of their children?** — `Q7` · `M09-❤️` 关系与归属感 ＋ `M13-❤️` 年龄与代际
2. **Should parents reward children? Why and how?** — `Q5` · `M09-❤️` 关系与归属感 ＋ `M06-💙` 规则与责任
3. **Is it good to reward children too often? Why?** — `Q5` · `M06-💙` 规则与责任 ＋ `M13-❤️` 年龄与代际
4. **On what occasions would adults be proud of themselves?** — `Q7` · `M13-❤️` 年龄与代际
5. **Do rewards help a child become better?** — `Q5` · `M06-💙` 规则与责任
6. **What do you think about children working hard just for grades?** — `Q5` · `M13-❤️` 年龄与代际
...
1. **Why do some people like to watch sports events?** — `Q1` · `M17-❤️` 艺术娱乐与想象力
2. **Where do people normally watch sports events?** — `Q7` · `M17-❤️` 艺术娱乐与想象力
3. **What are the advantages of watching sports events online?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
4. **What are the main differences between watching a sports event live in a stadium and watching it on TV?** — `Q2` · `M17-❤️` 艺术娱乐与想象力
5. **What kinds of sports events are most popular to watch in your country?** — `Q7` · `M17-❤️` 艺术娱乐与想象力
6. **What types of sports matches are suitable for children to watch?** — `Q7` · `M13-❤️` 年龄与代际
7. **What types of sports matches are suitable for children to attend?** — `Q7` · `M13-❤️` 年龄与代际
8. **Why do some people spend a lot going to other countries to watch sports events?** — `Q1` · `M11-❤️` 经济与就业 ＋ `M01-💚` 便利与效率
...
6. **Are there any occasions when people need to pretend to smile?** — `Q5` · `M19-❤️` 习惯情绪与休闲 ＋ `M04-💙` 健康与福祉
...
1. **Do you think adults can have lots of imagination?** — `Q5` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际
2. **Do you think imagination is essential for scientists?** — `Q5` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
3. **What kinds of jobs need imagination?** — `Q7` · `M11-❤️` 经济与就业 ＋ `M17-❤️` 艺术娱乐与想象力
4. **What subjects are helpful for children's imagination?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M17-❤️` 艺术娱乐与想象力
5. **What games help develop children's imagination?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际
6. **How important is imagination to children?** — `Q5` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际

### 不享受的音乐活动

1. **What kind of music events do people like today?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
2. **Do you think children should receive some musical education?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M17-❤️` 艺术娱乐与想象力
3. **What are the differences between old and young people's music preferences?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际
4. **What kind of music events are there in your country?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
5. **Why do many people like listening to music while doing sports?** — `Q1` · `M04-💙` 健康与福祉 ＋ `M17-❤️` 艺术娱乐与想象力
6. **What are the differences between listening to music at home and at a live concert?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索

### 自行车/摩托车/汽车旅行

1. **Which form of vehicle is more popular in your country, bikes, cars or motorcycles?** — `Q7` · `M12-💙` 环境与可持续性
2. **Do you think air pollution comes mostly from motor vehicles?** — `Q5` · `M12-💙` 环境与可持续性
3. **Do you think people need to change the way of transportation drastically to protect the environment?** — `Q5` · `M12-💙` 环境与可持续性
4. **How are the transportation systems in urban areas and rural areas different?** — `Q2` · `M12-💙` 环境与可持续性 ＋ `M02-💚` 公平与机会
5. **Why do more people own and drive private vehicles now?** — `Q1` · `M12-💙` 环境与可持续性
6. **What do you think of the future of electric cars?** — `Q4` · `M12-💙` 环境与可持续性

### 禁止用手机的场合

1. **How do young and old people use mobile phones differently?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M13-❤️` 年龄与代际
2. **What positive and negative impact do mobile phones have on friendship?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M09-❤️` 关系与归属感
3. **Is it a waste of time to take pictures with mobile phones?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
4. **Do you think it is necessary to have laws on the use of mobile phones?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M06-💙` 规则与责任
5. **What are examples of good and poor phone manners?** — `Q7` · `M06-💙` 规则与责任
6. **How does the internet benefit people?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
...
7. **How can people develop their national identity?** — `Q6` · `M22-💚` 文化身份与传统
...
7. **What should people do to achieve their goals?** — `Q6` · `M03-❤️` 学习与技能 ＋ `M11-❤️` 经济与就业

### 想拥有的科技产品

1. **What are the differences between the technology of the past and that of today?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M01-💚` 便利与效率
2. **What technology do young people like to use?** — `Q7` · `M20-❤️` 科技媒体与隐私 ＋ `M13-❤️` 年龄与代际
3. **What are the differences between online and face-to-face communication?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M05-💙` 沟通与信任
4. **Do you think technology has changed the way people communicate?** — `Q3` · `M20-❤️` 科技媒体与隐私 ＋ `M05-💙` 沟通与信任
5. **What negative effects does technology have on people's relationships?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M09-❤️` 关系与归属感
6. **What are the differences between making friends in real life and online?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M09-❤️` 关系与归属感

### 包含动物的故事或书

1. **Should schools teach children about animals?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M16-💚` 动物与宠物
2. **Some people think pets should not be kept in cities. What do you think?** — `Q7` · `M16-💚` 动物与宠物 ＋ `M18-❤️` 地点建筑与设施
3. **Many people regard pets as members of their family. What do you think?** — `Q7` · `M09-❤️` 关系与归属感 ＋ `M16-💚` 动物与宠物
4. **Do many people keep pets in your country?** — `Q5` · `M16-💚` 动物与宠物
5. **What are the advantages of keeping a pet?** — `Q5` · `M16-💚` 动物与宠物
6. **Why do people always tell children stories with animals?** — `Q1` · `M16-💚` 动物与宠物 ＋ `M17-❤️` 艺术娱乐与想象力

### 名人广告

1. **What are the advantages and disadvantages of advertisements?** — `Q5` · `M15-💙` 名人与广告
2. **Why are many advertisements endorsed by celebrities? How useful are they?** — `Q1` · `M15-💙` 名人与广告
3. **What is the most important factor in an advertisement?** — `Q7` · `M08-💙` 信息与判断 ＋ `M15-💙` 名人与广告
4. **Why are some advertisements boring?** — `Q1` · `M15-💙` 名人与广告 ＋ `M19-❤️` 习惯情绪与休闲
5. **Is advertising important for a company? Why?** — `Q5` · `M15-💙` 名人与广告
6. **Which is more effective, online advertising or offline advertising?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M15-💙` 名人与广告

### 想颁布的新法律

1. **What rules should students follow at school?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M06-💙` 规则与责任
2. **Do people in your country usually obey the law?** — `Q5` · `M06-💙` 规则与责任
3. **What kinds of behavior are considered as good behavior?** — `Q7` · `M06-💙` 规则与责任
4. **Do you think children can learn about the law outside of school?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M06-💙` 规则与责任
5. **What are the benefits for people if they obey the rules?** — `Q5` · `M06-💙` 规则与责任
6. **How can parents teach children to obey rules?** — `Q6` · `M09-❤️` 关系与归属感 ＋ `M06-💙` 规则与责任

### 对家庭重要的东西

1. **What things do families keep for a long time?** — `Q7` · `M09-❤️` 关系与归属感 ＋ `M05-💙` 沟通与信任
2. **What's the difference between things valued by people in the past and today?** — `Q3` · `M09-❤️` 关系与归属感
3. **What kinds of things are kept in museums?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
4. **What's the influence of technology on museums?** — `Q7` · `M20-❤️` 科技媒体与隐私 ＋ `M17-❤️` 艺术娱乐与想象力
5. **What are the benefits of technology for learning history?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能
6. **Why do people visit museums?** — `Q1` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索

### Apps/程序

1. **What are the differences between old and young people when using apps?** — `Q2` · `M20-❤️` 科技媒体与隐私 ＋ `M13-❤️` 年龄与代际
...
1. **What kind of job can be called a 'dream job'?** — `Q7` · `M11-❤️` 经济与就业 ＋ `M03-❤️` 学习与技能
...
1. **What kind of videos do people in your country like to watch?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
2. **Which is more helpful, watching videos or reading books?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
3. **What skills can people learn from watching videos?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M17-❤️` 艺术娱乐与想象力
4. **What are the advantages of online learning?** — `Q5` · `M20-❤️` 科技媒体与隐私 ＋ `M03-❤️` 学习与技能
5. **Are there any differences between the videos that young people and old people like to watch?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际
6. **Are there any differences between the videos that young men and young women like to watch?** — `Q2` · `M17-❤️` 艺术娱乐与想象力 ＋ `M13-❤️` 年龄与代际
7. **What makes a video go viral online?** — `Q1` · `M20-❤️` 科技媒体与隐私 ＋ `M17-❤️` 艺术娱乐与想象力
...
1. **What kind of rules do schools in China have?** — `Q7` · `M03-❤️` 学习与技能 ＋ `M06-💙` 规则与责任
2. **How does technology affect the law?** — `Q7` · `M20-❤️` 科技媒体与隐私 ＋ `M06-💙` 规则与责任
3. **Will there be a law that is universally accepted?** — `Q4` · `M06-💙` 规则与责任 ＋ `M22-💚` 文化身份与传统
4. **What environmental laws does your country already have?** — `Q7` · `M06-💙` 规则与责任 ＋ `M12-💙` 环境与可持续性
...
1. **What programs do people like to watch in your country?** — `Q7` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
2. **Do people in your country like to watch foreignTV programs?** — `Q5` · `M17-❤️` 艺术娱乐与想象力 ＋ `M10-💙` 创造力与探索
3. **What's the benefit of letting kids watch animal videos than visiting zoos?** — `Q5` · `M16-💚` 动物与宠物 ＋ `M17-❤️` 艺术娱乐与想象力
4. **Do teachers play videos in class in your country?** — `Q5` · `M03-❤️` 学习与技能 ＋ `M17-❤️` 艺术娱乐与想象力
