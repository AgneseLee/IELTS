# IELTS Speaking Part 3 六角机制答案

> 按 28 个保留的 Part 2 话题整理。T01–T10 负责题目语境；M01–M06 是答案的唯一主论证机制。每题一个主机制，必要时最多两个。
...
> 机制：`M01 实用价值` ＋ `M06 长期能力与短期便利`

Doctors with rare or demanding skills are usually more useful in difficult cases. Their work may also require more training, time and responsibility, so hospitals offer higher pay to attract them. For example, an experienced surgeon can perform operations that a newly qualified doctor cannot. So, differences in practical value and effort often lead to different salaries.
...
Successful people are usually more willing to practise, accept feedback and improve after mistakes. Ordinary people may have similar goals, but they often stop when progress becomes difficult. For example, a successful athlete reviews each performance and adjusts the next training session. Overall, consistent improvement is often the main difference.
...
> 机制：`M04 接触与熟悉度` ＋ `M01 实用价值`

Yes, especially in large cities and international workplaces. People hear foreign languages at school, at work and in entertainment, so they become more familiar with learning them. For example, many office workers study English because they regularly deal with overseas customers. However, foreign-language use is less common in some smaller communities. Overall, regular exposure and practical need encourage language learning.
...
Yes, some people learn languages such as Japanese, Korean or Spanish. They usually choose one that is useful for work, travel or communication with people they know. For example, an employee may learn Japanese before joining a company with Japanese clients. So, people are more likely to learn another language when it meets a real need.
...
Some do, but it is more common among people who have enough space and time. Home growing is practical when a balcony or garden makes daily care easy. For example, someone with a sunny balcony may keep a few pots of herbs for cooking. However, people in small flats may find the effort less worthwhile. Overall, convenience strongly affects whether people grow plants.
...
Most people use both for different needs. Big stores are convenient for buying many items at once, while small shops are useful for quick purchases and personal service. For example, a family may visit a supermarket weekly but buy fresh bread from a nearby bakery. Overall, the more practical option depends on what the customer needs.
...
> 机制：`M02 时间与精力成本` ＋ `M01 实用价值`

It is possible, but it takes considerable time and effort. New owners need to understand customers, control costs and improve their service through feedback. For example, a small restaurant may need months to build a group of regular customers. That said, clear guidance can make the process easier. Overall, setting up a business is manageable but demanding.
...
People often speak more freely with friends because they choose those relationships themselves. Family conversations may involve more responsibility and advice because relatives share long-term obligations. For example, someone may discuss hobbies with a friend but ask a parent about an important career choice. Overall, the relationship changes both the purpose and tone of the conversation.
...
Yes, visiting relatives and close friends is still common, especially during festivals. People grow up seeing home visits as a normal way to maintain relationships, so the habit remains familiar. For example, families often visit older relatives during the Spring Festival. Overall, regular cultural exposure helps the custom continue.
...
Yes, they are common in major cities where land is limited. Tall buildings use a small area to provide homes and offices for many people. For example, one residential tower can house hundreds of families near public transport. Overall, their practical use of space makes them common in dense cities.
...
Yes, people often change plans when the original option becomes impractical. A delay, new responsibility or lack of time may make another choice easier. For example, someone may move an outdoor meeting indoors when heavy rain is expected. Overall, plans usually change to fit current needs and limits.
...
Yes, particularly when the news affects daily life. People discuss road closures, local events or new facilities because that information has immediate practical value. For example, neighbours may talk about a new metro station near their homes. Overall, useful local news naturally creates conversation.
...
Older people often care more because they may have lived in the same community for longer. Years of contact with local places and neighbours make community events more familiar and relevant. For example, a retired resident may follow changes to a nearby clinic closely. Overall, longer exposure often creates stronger interest in local news.
...
Higher positions offer more control, recognition and responsibility. Young people may also see successful managers around them and use those people as career models. For example, a junior employee may aim for promotion after watching a respected team leader make important decisions. So, both autonomy and social influence can drive this ambition.
...
Yes, keeping pets is fairly common, especially among families that have enough time and space. People are more willing to own an animal when companionship is valuable and daily care is manageable. For example, a family with a flexible routine may find it easy to walk a dog every day. Overall, practical conditions strongly influence pet ownership.
...
Online advertising is usually more effective for younger consumers because they see it regularly and can act on it immediately. Offline advertising can work better when it reaches people in a relevant physical setting. For example, a restaurant advert on a food app, while a local event uses posters near the venue. Overall, effectiveness depends on exposure and practical access.
...
> 机制：`M03 自主权与责任感` ＋ `M05 社会影响与模仿`

Most people obey basic laws when the rules are familiar and the consequences are clear. They also copy the behaviour they regularly see around them. For example, drivers are more likely to stop at a red light when everyone else does the same. However, inconsistent enforcement can weaken responsible behaviour. Overall, clear expectations and social influence encourage obedience.
...
It depends on the learning goal. Videos make physical processes easier to observe, while books require learners to interpret ideas and build concentration independently. For example, a cooking video clearly demonstrates a technique, but a textbook may explain the principle behind it in more depth. Overall, each format develops different abilities.
...
There may be small differences, but gender is not the best predictor. People usually watch content that matches their interests, and recommendations from friends can strengthen those preferences. For example, young men and women in the same dance group may follow exactly the same creators. Overall, personal interests and social circles matter more than gender.
...
Probably not, because people grow up with different values and social expectations. These differences shape which rules feel familiar, fair or acceptable. For example, a restriction that is normal in one culture may seem excessive in another. So, governments can seek broad support, but universal acceptance is unrealistic.
...
Common examples include limits on industrial emissions, rules against littering and requirements for waste sorting. These laws make individual and business responsibilities clearer. For example, a factory may have to treat polluted water before releasing it. Overall, effective environmental laws turn responsibility into specific behaviour.
