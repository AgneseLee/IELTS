...
- `archive/answers-August/part2-{people,events,places,things}.md`: archived story facts and aggregate answers.
- [`archive/answers-August/part2-people-transferable-skills.md`](archive/answers-August/part2-people-transferable-skills.md): archived ability examples.
- [`archive/`](archive/): retired plans and question banks; reference only.

New material goes into the current canonical document above. Avoid creating parallel indexes.
