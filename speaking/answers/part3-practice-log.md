...
It is very important for schools to help children become smarter. Regular practice and professional feedback build practical skills and improve academic performance. For example, asking pupils to design their own experiment teaches them to apply knowledge and evaluate results. However, schools should help students develop independent thinking rather than focus entirely on exams.

### ✅ What do you think about children working hard just for grades?

- [ ] 不看稿口述

I do not think working only for grades is healthy. It encourages passive, exam-driven learning with limited practical application. For example, a student may memorise an essay for a test but be unable to explain the same idea in their own words. Children also need meaningful practice and feedback so they can develop useful skills and think independently.

### ✅ What should people consider when choosing jobs?

- [ ] 不看稿口述

They should mainly consider whether the job matches their skills and offers useful training. Reliable information about these priorities helps them make an informed decision. For example, someone who wants to develop technical skills should compare the actual training programmes offered by different employers. As a result, they are less likely to choose an unsuitable position.
