...
1. Introduction: state what is produced, transformed or recycled.
2. Overview: process type, main transformation, start/end or returning material.
3. Body 1: preparation or early stages.
4. Body 2: transformation, final product or cycle closure.
